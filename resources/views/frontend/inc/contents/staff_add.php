                ...
                <form id="cusform" action="javascript:void 0" method="post" autocomplete="off" v-on:submit="create()">
                    ...
                    <div class="pr_10 pl_10">
                        ...
                        <div class="pt_5 fm-smreap">
                            <label for="birthdate">ថ្ងៃខែឆ្នាំកំណើត<span v-if="errors.birthdate" class="c_6"> : {{ errors.birthdate[0] }}</span></label>
                            <div class="ds_f">
                                <input id="birthdate" type="date" v-model="params.birthdate" class="input-1 box-s4 bd_n b_r_4 pt_3 pb_3 fm-smreap wp_100 fs_16 pr_10 pl_10">
                            </div>
                        </div>

                        <div class="pt_5 fm-smreap">
                            <label for="start_date">ថ្ងៃចូលធ្វើការ<span v-if="errors.start_date" class="c_6"> : {{ errors.start_date[0] }}</span></label>
                            <div class="ds_f">
                                <input id="start_date" type="date" v-model="params.start_date" class="input-1 box-s4 bd_n b_r_4 pt_3 pb_3 fm-smreap wp_100 fs_16 pr_10 pl_10">
                            </div>
                        </div>

                        <div class="pt_5 fm-smreap">
                            <label for="department">ផ្នែក<span v-if="errors.department" class="c_6"> : {{ errors.department[0] }}</span></label>
                            <div class="ds_f">
                                <input id="department" v-model="params.department" type="text" class="input-1 box-s4 bd_n b_r_4 pt_3 pb_3 fm-smreap wp_100 fs_16 pr_10 pl_10">
                            </div>
                        </div>
    ...
    let vapp = new Vue({
        ...
        data:{
            ...
            params:{
                ...
                note:"",
                department:"",
                birthdate:"<?php echo date("Y")-6 . "-01-01"; ?>",
        ...
        methods:{
            create:function (){
                let crte = this;
                crte.errors = [];
                axios.post("<?php echo route("staff.store"); ?>", null, {
                    headers:$_i.headers,
                    params:this.params,
                    ...
                    if (created.data.error){
                        ...
                        if (crte.multiple){
                            ...
                            window.location.href = "<?php echo route("staff"); ?>";
                        }
                    }
